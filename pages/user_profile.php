                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu footer-menu-002">
                        ...
                        <ul class="menu-list list-unstyled text-uppercase border-animation-left fs-6">
                            ...
                            <li class="menu-item">
                                <a href="./About_us.html" class="item-anchor">About us</a>
                            </li>
                            <li class="menu-item">
                                <a href="./contact.html" class="item-anchor">Contact</a>
                            </li>
                            <li class="menu-item">
                                <a href="./pages/contact.html" class="item-anchor">Profile</a>
                            </li>
                            <li class="menu-item">
                                <a href="./pages/contact.html" class="item-anchor">Login</a>
                            </li>
                        </ul>
                    </div>
                </div>
