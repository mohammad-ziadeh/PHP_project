                    ...
                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                        ...
                        <div class="offcanvas-body">
                            <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                                ...
                                <li class="nav-item ">
                                    <a class="nav-link" href="./About_us.php" style="color: #c5a15b;">About
                                        us</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <ul class="list-unstyled d-flex m-0">
                        ...
                        <li class="d-none d-lg-block">
                            <a href="./index.html" class="text-uppercase mx-3" data-bs-toggle="offcanvas"
                                ...
                                style="color: #c5a15b;">Cart <span class="cart-count">(0)</span>
                            </a>
                        </li>
                        <li class="d-lg-none">
                            <a href="#" class="mx-2">
            ...
            <div class="row d-flex flex-wrap justify-content-between py-5">
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu footer-menu-001">
                        ...
                        <p style="color: #c5a15b; ">Gravida massa volutpat aenean odio. Amet, turpis erat nullam
                            fringilla elementum
                            diam in. Nisi, purus
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu footer-menu-002">
                        ...
                        <ul class="menu-list list-unstyled text-uppercase border-animation-left fs-6">
                            ...
                            <li class="menu-item">
                                <a href="./sign_up.php" class="item-anchor" style="color: #c5a15b;">Login</a>
                            </li>
                        </ul>
                    </div>
                </div>
