      ...
      <div class="row justify-content-between align-items-center w-100">
        ...
        <div class="col-auto">
          <a class="navbar-brand" href="./index.php">
            <svg width="112" height="45" viewBox="0 0 112 45" xmlns="http://www.w3.org/2000/svg" fill="#c5a15b">
              <path
          ...
          <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
            ...
            <div class="offcanvas-body">
              <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="./pages/dashboard.php" style="color: #c5a15b;">Profile</a>
                </li>
                <li class="nav-item">
          ...
          <div class="swiper-wrapper d-flex border-animation-left">
              ...
              <div class="banner-item image-zoom-effect">
                ...
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
                    <a href="./index.php" class="item-anchor" style="color: #c5a15b;">Soft leather jackets</a>
                  </h5>
            ...
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                ...
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
                    <a href="./index.php" class="item-anchor">Out crop sweater</a>
                  </h5>
                  <p>Scelerisque duis aliquam qui lorem ipsum dolor amet, consectetur adipiscing elit.</p>
                  <div class="btn-left">
                    <a href="#" class="btn-link fs-6 text-uppercase item-anchor text-decoration-none">Discover Now</a>
            ...
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                ...
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
                    <a href="./index.php" class="item-anchor">Soft leather jackets</a>
                  </h5>
                  <p>Scelerisque duis aliquam qui lorem ipsum dolor amet, consectetur adipiscing elit.</p>
                  <div class="btn-left">
                    <a href="#" class="btn-link fs-6 text-uppercase item-anchor text-decoration-none">Discover Now</a>
        ...
        <div class="row">
            ...
            <div class="cat-item image-zoom-effect">
              ...
              <div class="category-content">
                <div class="product-button">
                  <a href="./index.php" class="btn btn-common text-uppercase" style="color: #c5a15b;">Shop for men</a>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="cat-item image-zoom-effect">
              ...
              <div class="category-content">
                <div class="product-button">
                  <a href="./index.php" class="btn btn-common text-uppercase" style="color: #c5a15b;">Shop for
                    women</a>
                </div>
              </div>
            </div>
        ...
        <div class="collection-item d-flex flex-wrap my-5">
          ...
          <div class="col-md-6 column-container " style="background-color: #1e1e20;">
            <div class="collection-content p-5 m-0 m-md-6">
              <h3 class="element-title text-uppercase" style="color: #c5a15b;">Classic winter collection</h3>
            ...
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                ...
                <div class="product-content">
                  ...
                  <a href="./index.php" class="text-decoration-none" style="color: #c5a15b;"
                    data-after="Add to cart"><span style="color: #c5a15b;">$95.00</span></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                ...
                <div class="product-content">
                  ...
                  <a href="./index.php" class="text-decoration-none" style="color: #c5a15b;"
                    data-after="Add to cart"><span style="color: #c5a15b;">$55.00</span></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                ...
                <div class="product-content">
                  ...
                  <a href="./index.php" class="text-decoration-none" style="color: #c5a15b;"
                    data-after="Add to cart"><span style="color: #c5a15b;">$65.00</span></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                ...
                <div class="product-content">
                  ...
                  <a href="./index.php" class="text-decoration-none" style="color: #c5a15b;"
                    data-after="Add to cart"><span style="color: #c5a15b;">$70.00</span></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder">
                ...
                <div class="product-content">
                  ...
                  <a href="./index.php" class="text-decoration-none" style="color: #c5a15b;"
                    data-after="Add to cart"><span style="color: #c5a15b;">$50.00</span></a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 text-end">
            <p>© Copyright 2025 Kaira. All rights reserved</p>
          </div>
        </div>
      </div>
    </div>
