    ...
    $database = "php_project"; // Your DB name
    ...
    <body class="homepage" style="background-color: #1e1e20;">
      ...
      <div class="search-popup">
        <div class="search-popup-container">
          ...
          <h5 class="cat-list-title" style="color: #c5a15b;">Browse Categories</h5>
        </div>
      </div>
      ...
      <section id="billboard" class=" py-5" style="background-color: #1e1e20;">
        <div class="container">
          <div class="row justify-content-center">
            <h1 class="section-title text-center mt-4" data-aos="fade-up" style="color: #c5a15b;">New Collections</h1>
              ...
              <div class="swiper-wrapper d-flex border-animation-left">
                <div class="swiper-slide">
                  <div class="banner-item image-zoom-effect">
                    <div class="image-holder">
                      <a href="#">
                        <img src="https://i.imgur.com/N1Kt2TO.png" alt="product" class="img-fluid"
                          onmouseover="this.src='https://i.imgur.com/A19akEF.png'"
                          onmouseout="this.src='https://i.imgur.com/N1Kt2TO.png'">
                      </a>
                    </div>
                    <div class="banner-content py-4">
                      <h5 class="element-title text-uppercase">
                        <a href="./index.php" class="item-anchor" style="color: #c5a15b;">Men's Sleek Black Suit - Midnight Elegance

                        </a>
                      </h5>
                      <p>Modern. Sharp. Innovative.Elite Suits offers a premium selection of men's styles from tailored suits to luxury sportswear.</p>
                    </div>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="banner-item image-zoom-effect">
                    <div class="image-holder">
                      <a href="#">
                        <img src="https://i.imgur.com/1DWMkYU.png" alt="product" class="img-fluid"
                          onmouseover="this.src='https://i.imgur.com/85fJ9Os.png'"
                          onmouseout="this.src='https://i.imgur.com/1DWMkYU.png'">
                      </a>
                    </div>
                    <div class="banner-content py-4">
                      <h5 class="element-title text-uppercase">
                        <a href="./index.php" class="item-anchor" style="color: #c5a15b;">Men's Classic Tailored Fit Suit - Black Elegance</a>
                      </h5>
                      <p> Inspired by craft and premium materials. Refined wool from the Italian mill Lanificio di Tollegno. Streamlined in a slim silhouette.</p>
                    </div>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="banner-item image-zoom-effect">
                    <div class="image-holder">
                      <a href="#">
                        <img src="https://i.imgur.com/2fjtTxn.png" alt="product" class="img-fluid"
                          onmouseover="this.src='https://i.imgur.com/xXCOMns.png'"
                          onmouseout="this.src='https://i.imgur.com/2fjtTxn.png'">
                      </a>
                    </div>
                    <div class="banner-content py-4">
                      <h5 class="element-title text-uppercase">
                        <a href="./index.php" class="item-anchor" style="color: #c5a15b;">Men's Navy Blue Suit - Royal Charm</a>
                      </h5>
                      <p>Modern. Sharp. Innovative.Elite Suits offers a premium selection of men's styles from tailored suits to luxury sportswear.
                      </p>
                    </div>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="banner-item image-zoom-effect">
                    <div class="image-holder">
                      <a href="#">
                        <img src="https://i.imgur.com/Lwt7a5v.png" alt="product" class="img-fluid"
                          onmouseover="this.src='https://i.imgur.com/gqefXGf.png'"
                          onmouseout="this.src='https://i.imgur.com/Lwt7a5v.png'"> </a>
                    </div>
                    <div class="banner-content py-4">
                      <h5 class="element-title text-uppercase">
                        <a href="./index.php" class="item-anchor" style="color: #c5a15b;">Men's Black Suit - Eclipse Noir</a>
                      </h5>
                      <p>Modern. Sharp. Innovative.Elite Suits offers a premium selection of men’s styles from tailored suits to luxury sportswear.</p>
                    </div>
                  </div>
                ...
                <div class="swiper-slide">
                  <div class="banner-item image-zoom-effect">
                    <div class="image-holder">
                      <a href="#">
                        <img src="https://i.imgur.com/WofkvcT.png" alt="product" class="img-fluid"
                          onmouseover="this.src='https://i.imgur.com/EhT7PDi.png'"
                          onmouseout="this.src='https://i.imgur.com/WofkvcT.png'">
                      </a>
                    </div>
                    <div class="banner-content py-4">
                      <h5 class="element-title text-uppercase">
                        <a href="./index.php" class="item-anchor" style="color: #c5a15b;">Black Men's Suit - Azure Royale</a>
                      </h5>
                      <p>Modern. Sharp. Innovative. Elite Suits offers a premium selection of men’s styles from tailored suits to luxury sportswear.</p>
                    </div>
                  </div>
                ...
                <div class="swiper-slide">
                  <div class="banner-item image-zoom-effect">
                    <div class="image-holder">
                      <a href="#">
                        <img src="https://i.imgur.com/RwiyaGv.png" alt="product" class="img-fluid"
                          onmouseover="this.src='https://i.imgur.com/iDFKj8U.png'"
                          onmouseout="this.src='https://i.imgur.com/RwiyaGv.png'"> </a>
                    </div>
                    <div class="banner-content py-4">
                      <h5 class="element-title text-uppercase">
                        <a href="./index.php" class="item-anchor" style="color: #c5a15b;">Timeless Grey Sophistication - Noir Elegance</a>
                      </h5>
                      <p>Modern. Sharp. Innovative. Elite Suits offers a premium selection of men’s styles from tailored suits to luxury sportswear.</p>
      ...
      <section class="features py-5" style="background-color: #1e1e20; color: #686868;">
        <div class="container">
          <div class="row">
            <div class="col-md-3 text-center" data-aos="fade-in" data-aos-delay="0">
              <div class="py-5">
                ...
                <h4 class="element-title text-capitalize my-3" style="color: #c5a15b;">Book An Appointment</h4>
            ...
            <div class="col-md-3 text-center" data-aos="fade-in" data-aos-delay="300">
              <div class="py-5">
                ...
                <h4 class="element-title text-capitalize my-3" style="color: #c5a15b;">Pick up in store</h4>
                <p>At imperdiet dui accumsan sit amet nulla risus est ultricies quis.</p>
              </div>
            </div>
            <div class="col-md-3 text-center" data-aos="fade-in" data-aos-delay="600">
              <div class="py-5">
                ...
                <h4 class="element-title text-capitalize my-3" style="color: #c5a15b;">Special packaging</h4>
                <p>At imperdiet dui accumsan sit amet nulla risus est ultricies quis.</p>
              </div>
            </div>
            <div class="col-md-3 text-center" data-aos="fade-in" data-aos-delay="900">
              <div class="py-5">
                ...
                <h4 class="element-title text-capitalize my-3" style="color: #c5a15b;">free global returns</h4>
                <p>At imperdiet dui accumsan sit amet nulla risus est ultricies quis.</p>
              </div>
            </div>
          </div>
      ...
      <section class="categories overflow-hidden" style="background-color: #1e1e20;">
        <div class="container">
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="cat-item image-zoom-effect">
                  <div class="image-holder">
                    <a href="./index.php">
                      <img src="https://i.imgur.com/gylPYJA.png" alt="categories" class="product-image img-fluid">
                    </a>
                  </div>
                  <div class="category-content">
                    <div class="product-button">
                      <a href="./index.php" class="btn btn-common text-uppercase" style="color: #c5a15b;">Shop for Suits</a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-4">
                <div class="cat-item image-zoom-effect">
                  <div class="image-holder">
                    <a href="./index.php">
                      <img src="https://i.imgur.com/MK3SkeI.png" alt="categories" class="product-image img-fluid">
                    </a>
                  </div>
                  <div class="category-content">
                    <div class="product-button">
                      <a href="./index.php" class="btn btn-common text-uppercase" style="color: #c5a15b;">Shop Shoes</a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-4">
                <div class="cat-item image-zoom-effect">
                  <div class="image-holder">
                    <a href="./index.php">
                      <img src="https://i.imgur.com/RBkwwFt.png" alt="categories" class="product-image img-fluid">
                    </a>
                  </div>
                  <div class="category-content">
                    <div class="product-button">
                      <a href="./index.php" class="btn btn-common text-uppercase" style="color: #c5a15b;">Shop
                        accessories</a>
                    </div>
                  </div>
                </div>
      ...
      <section class="collection position-relative py-5" style="background-color: #686868;">
        <div class="container">
          <div class="row">
            ...
            <div class="collection-item d-flex flex-wrap my-5">
              <div class="col-md-6 column-container">
                <div class="image-holder">
                  <img src="https://i.imgur.com/9J8zEr8.png" alt="collection" class="product-image img-fluid">
                </div>
              </div>
              <div class="col-md-6 column-container " style="background-color: #1e1e20;">
                <div class="collection-content p-5 m-0 m-md-6">
                  <h3 class="element-title text-uppercase" style="color: #c5a15b;">Classic Summer collection</h3>
                  ...
                  <a href="#" class="btn text-uppercase mt-3" style="color: #c5a15b; background-color: #686868;">Shop
                    Collection</a>
                </div>
              </div>
            </div>
      ...
      <section id="best-sellers" class="best-sellers product-carousel py-5 position-relative overflow-hidden"
        ...
        <div class="container">
          <div class="d-flex flex-wrap justify-content-between align-items-center mt-5 mb-3">
            <h4 class="text-uppercase" style="color: #c5a15b;">Best Selling Items</h4>
            <a href="./index.php" class="btn-link" style="color: #c5a15b;">View All Products</a>
          </div>
              ...
              <?php while ($row = $result->fetch_assoc()) { ?>
                <div class="swiper-slide">
                  <div class="product-item image-zoom-effect link-effect">
                    <div class="image-holder">
                      <a href="./index.php">
                        <img src="images/<?php echo $row['image']; ?>" alt="product" class="product-image img-fluid">
                      </a>
                      ...
                      <div class="product-content">
                        <h5 class="text-uppercase fs-5 mt-3">
                          <a href="./index.php" style="color: #c5a15b;"><?php echo $row['name']; ?></a>
                        </h5>
                        <a href="./index.php" class="text-decoration-none" data-after="Add to cart">
                          <span style="color: #c5a15b;">$<?php echo $row['price']; ?></span>
                        </a>
                      </div>
                    </div>
                  </div>
      ...
      <section class="video py-5 overflow-hidden" style="background-color: #1e1e20;">
        <div class="container-fluid">
          <div class="row">
            <div class="video-content open-up" data-aos="zoom-out">
              <div class="video-bg">
                <img src="https://i.imgur.com/3QVELQq.png" alt="video" class="video-image img-fluid">
              </div>
      ...
      <section class="testimonials py-5 " style="background-color: #686868; color: #c5a15b;">
        <div class="section-header text-center mt-5">
          <h3 class="section-title" style="color: #c5a15b;">WE LOVE GOOD COMPLIMENT</h3>
        </div>
      ...
      <section id="related-products" class="related-products product-carousel py-5 position-relative overflow-hidden"
        style="background-color: #1e1e20;">
        <div class="container">
          <div class="d-flex flex-wrap justify-content-between align-items-center mt-5 mb-3">
            <h4 class="text-uppercase" style="color: #c5a15b;">You May Also Like</h4>
            <a href="./index.php" class="btn-link" style="color: #c5a15b;">View All Products</a>
          </div>
          <div class="swiper product-swiper open-up" data-aos="zoom-out">
            <div class="swiper-wrapper d-flex">
              <div class="swiper-slide">
                <div class="product-item image-zoom-effect link-effect">
                  <div class="image-holder">
                    ...
                    <div class="product-content">
                      <h5 class="text-uppercase fs-5 mt-3">
                        <a href="./index.php" style="color: #c5a15b;">Dark florish onepiece</a>
                      </h5>
                      <a href="./index.php" class="text-decoration-none" data-after="Add to cart"><span
                          style="color: #c5a15b;">$95.00</span></a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="swiper-slide">
                <div class="product-item image-zoom-effect link-effect">
                  <div class="image-holder">
                    ...
                    <div class="product-content">
                      <h5 class="text-uppercase fs-5 mt-3">
                        <a href="./index.php" style="color: #c5a15b;">Baggy Shirt</a>
                      </h5>
                      <a href="./index.php" class="text-decoration-none" data-after="Add to cart"><span
                          style="color: #c5a15b;">$55.00</span></a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="swiper-slide">
                <div class="product-item image-zoom-effect link-effect">
                  <div class="image-holder">
                    ...
                    <div class="product-content">
                      <h5 class="text-uppercase fs-5 mt-3">
                        <a href="./index.php" style="color: #c5a15b;">Cotton off-white shirt</a>
                      </h5>
                      <a href="./index.php" class="text-decoration-none" data-after="Add to cart"><span
                          style="color: #c5a15b;">$65.00</span></a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="swiper-slide">
                <div class="product-item image-zoom-effect link-effect">
                  <div class="image-holder">
                    ...
                    <div class="product-content">
                      <h5 class="text-uppercase fs-5 mt-3">
                        <a href="./index.php" style="color: #c5a15b;">Handmade crop sweater</a>
                      </h5>
                      <a href="./index.php" class="text-decoration-none" data-after="Add to cart"><span
                          style="color: #c5a15b;">$50.00</span></a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="product-item image-zoom-effect link-effect">
                  <div class="image-holder">
                    ...
                    <div class="product-content">
                      ...
                      <a href="./index.php" class="text-decoration-none" data-after="Add to cart"><span
                          style="color: #c5a15b;">$70.00</span></a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-3 col-sm-6">
              <div class="footer-menu footer-menu-002">
                ...
                <ul class="menu-list list-unstyled text-uppercase border-animation-left fs-6">
                  ...
                  <li class="menu-item">
                    <a href="./pages/About_us.php" class="item-anchor" style="color: #c5a15b;">About us</a>
                  </li>
                  <li class="menu-item">
                    <a href="./pages/contact.php" class="item-anchor" style="color: #c5a15b;">Contact</a>
                  </li>
                  <li class="menu-item">
                    <a href="./pages/contact.php" class="item-anchor" style="color: #c5a15b;">Profile</a>
                  </li>
                  <li class="menu-item">
                    <a href="./pages/contact.php" class="item-anchor" style="color: #c5a15b;">Login</a>
                  </li>
                </ul>
              </div>
            </div>
